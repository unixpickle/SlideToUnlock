...
/**
 * Draw text at a given location in the image.
 * @param text The text to draw.
 * @param point The location at which the text will be drawn.
 * This starts at 0,0, or the top left hand corner.
 * @param theFont The font to use while drawing the text.
 * @param pixelColor The fill color to use for the text.
 */
- (void)drawText:(NSString *)text atPoint:(BMPoint)point font:(UIFont *)theFont color:(BMPixel)pixelColor;
